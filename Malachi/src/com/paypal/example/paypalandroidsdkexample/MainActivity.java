...
public class MainActivity extends Activity {
    ...
    public void onBuyPressed(View pressed) {
        PayPalPayment thingToBuy = new PayPalPayment(new BigDecimal("1.75"), "USD", "Pay tithe");
    ...
    */
    ...
    public void payTithe(View pressed){
    	Intent intent = new Intent(this, MyCalculatorActivity.class);
    	
    	//get input from user (either calculate 10% or specify custom mount.  
    	
    	
    	startActivity(intent);
    }
    
    public void viewWeb(View pressed){
